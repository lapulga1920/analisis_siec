# Análisis SIEC - Programa de Medicina
...
| Pos | Competencia | Promedio | Evaluaciones | % Abstracto | Estado |
|-----|-------------|----------|--------------|-------------|--------|
...
### Análisis de Evaluaciones Deficientes (< 2.0)
